...
export const SCREENS = {
  ...
  donesend: a3a.donesend, share: a3a.share, receipt: a3a.receipt,
  ...
  donein: a3b.donein, sharein: a3b.sharein, donecard: a3b.donecard,
  ...
  },
  {
    ...
    sections: [
      ...
      { name: 'Sending money', aim: 'Voice, camera or typing, all landing on the same confirmation.',
        screens: ['ask', 'scan', 'typed', 'pay', 'chat', 'donesend', 'share', 'receipt'] },
      ...
      { name: 'Look at what happened', aim: 'The whole feed, and an answer about any line in it.',
        screens: ['history', 'answer', 'donein', 'sharein', 'donecard'] },
