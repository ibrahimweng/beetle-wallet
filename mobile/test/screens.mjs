...
const TYPES = { '.html': 'text/html', '.js': 'text/javascript', '.json': 'application/json', '.css': 'text/css', '.png': 'image/png', '.ttf': 'font/ttf', '.woff2': 'font/woff2' };
...
for (const id of ids) {
  ...
  if (text.includes('Not built in React Native yet')) { toBuild.push(id); continue; }
...
console.log(`screens: ${built}/${ids.length} built, ${broken.length} broken, ${toBuild.length} still to build`);
