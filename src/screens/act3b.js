...
export const servicesScreen = {
  title: 'All services',
  render: () => Screen([
    PageHead('All services', 'Everything that is not sending or receiving', { big: true }),
    Card(...services.map((s, i) => e('div', null,
      i ? Divider() : null,
      e('div', { class: 'listrow', onClick: () => go(s.to) }, Glyph(s.icon),
        e('div', { class: 'grow stack gap-1' },
          e('div', { class: 'listrow-title' }, s.name),
          e('div', { class: 'listrow-sub' }, s.sub)),
        e('div', { class: 'chev' }, '›'))))),
    Bubble('Ask me for any of these instead of hunting for them. Saying pay my light bill gets you further than three taps.'),
  ], Dock({ placeholder: 'Ask for a service', back: () => go('home') })),
};
